\documentclass[draft, a4paper, 10pt]{memoir}
...
\newtheoremstyle{theoreme}
 ...
 {} %ponctuation aprÃ¨s le titre
 {\newline} %espace aprÃ¨s le titre
...
\DeclareMathOperator{\kp}{kp}
	...
	% DiffÃ©rentielles %
\newcommand{\diff}[1]{\mathrm{d}#1} %Ã©lÃ©ment diffÃ©rentiel
\newcommand{\dpart}[2]{\frac{\partial #1}{\partial #2}} %dÃ©rivÃ©e partielle d'ordre 1

	% Ensembles %
\newcommand{\N}{\mathbb{N}} %entiers naturels
\newcommand{\R}{\mathbb{R}} %rÃ©els
...
\def\restriction#1#2{\mathchoice %restriction d'une fonction Ã  un ensemble
...
\DeclareMathOperator{\vect}{Vect} %espace vectoriel engendrÃ©
