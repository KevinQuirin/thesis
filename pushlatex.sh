...
if [ `git rev-parse --abbrev-ref HEAD` == "$branch" ]; then
    ...
    cp main.pdf ../thesis-gh-pages/thesis/main.pdf #copy the generated pdf to the gh-pages folder
    cp errors.txt ../thesis-gh-pages/thesis/errors.txt #copy the list of errors to the gh-pages folder
    cd ../thesis-gh-pages/thesis/ #go to the gh-pages folder
